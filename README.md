...
some stuff when doing things with 3DS games and applications (.3ds/.cci, .cia)
...
* `rsfgen-norom.py` - modified rsfgen, generates a .rsf only using decrypted exheader and a template rsf, does not automatically get CompanyCode or UniqueId
